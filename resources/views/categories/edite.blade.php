...
<title>edite categorie</title>
  ...
  #submit-button {
    ...
    text-decoration: none;
    cursor: pointer;
    /* Optional: Add padding to make the text easier to click */
    padding: 4px;
  }
  #submit-button:hover {
...
<body>
  ...
  <form action="{{ route('categorie.update') }}" method="POST">
    ...
    <div class="user-box">
      <input type="text" name="title" value="{{ $categorie->title }}" required>
      <label>Title</label>
    </div>
    <div class="user-box">
